...
const renderFilms = (data, container, onDataChange, onViewChange) => {
...
export default class PageController {
  ...
  _renderShowMoreBtn(films) {
    ...
    this._showMoreBtnComponent.setClickHandler(() => {
      ...
      const newFilms = renderFilms(sortedFilms, this._filmsListContainer,
  ...
  _onSortTypeChange(sortType) {
    ...
    const newFilms = renderFilms(sortedData, this._filmsListContainer,
        this._onDataChange, this._onViewChange);
  ...
  _onDataChange(movieController, oldData, newData) {
    ...
    this._films = [].concat(this._films.slice(0, index),
        newData, this._films.slice(index + 1));
    movieController.updateMovieControllerData(this._films[index]);
  }
